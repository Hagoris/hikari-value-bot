...
def send_welcome(message):
    intro_msg = (
        ...
        "item values and explore recommended character builds.\n\n"
...
def send_list(message):
    try:
        ...
        bot.send_message(message.chat.id, "⚠️ Error: Make sure the Bot is an Admin in the Channel and LIST_MESSAGE_ID is correct.")
